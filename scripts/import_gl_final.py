#!/usr/bin/env python3
"""
Final script to import GL data with proper Opening/Change/Closing rows
"""
...
def import_gl_final():
    """Import GL data with proper Opening/Change/Closing structure"""
    with app.app_context():
        try:
            print("Starting final GL data import with proper structure...")
            ...
            print("2024 GL data imported with proper Opening/Change/Closing structure!")
            ...
            print(f"Error in final import: {e}")
            db.session.rollback()
            import traceback
            traceback.print_exc()
