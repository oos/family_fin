#!/usr/bin/env python3
"""
Script to import 2024 GL data with proper account grouping
"""
...
def import_gl_2024_grouped():
    """Import 2024 GL data with proper account grouping"""
    with app.app_context():
        try:
            ...
            for _, row in gl_data.iterrows():
                ...
                elif current_gl_account and name not in ['Change', 'Close', '']:
            ...
            for gl_account, transactions in gl_accounts.items():
                ...
                total_debit = sum(float(t['debit']) for t in transactions)
                total_credit = sum(float(t['credit']) for t in transactions)
            ...
            print("2024 GL data imported with proper grouping!")
